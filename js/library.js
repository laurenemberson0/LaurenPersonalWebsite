...
const ICONS = {
  ...
  wikipedia:
    '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M23.1 4.5v.6c-.7.1-1.2.3-1.6.7-.4.4-.8 1-1.2 2L15.9 19h-.6l-3-6.4L9 19h-.6L3.7 7.8c-.4-.9-.7-1.5-1-1.8-.3-.3-.7-.5-1.4-.5v-.6h5.6v.6c-.5 0-.9.1-1.1.3-.2.1-.3.3-.3.6 0 .2.1.6.4 1.2l3.1 7.3 2-4.4-.9-2.1c-.3-.7-.6-1.2-.9-1.5-.3-.3-.7-.5-1.3-.5v-.6h4.9v.6c-.5 0-.9.1-1.1.3-.2.1-.2.4-.2.7 0 .2.1.5.3.9l1.9 4.5 1.9-4.4c.2-.6.4-1 .4-1.2 0-.2-.1-.4-.3-.6-.2-.1-.6-.2-1.1-.2v-.6h4.6z"/></svg>',
  goodreads:
